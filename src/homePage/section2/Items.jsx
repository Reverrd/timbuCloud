                ...
                <div key={smartWatch.id} className=' p-4  bg-[#FDFDFD] rounded-3xl' >
                    <div className='flex justify-between items-center pb-2'>
                      ...
                      <div className='cursor-pointer' onClick={()=>countCartMinus(smartWatch.id)} >
                         <img className='mb-4 w-[3.9vw]' src="./assets/minus.png" alt="" />
                         
                      </div>
                        <div className='cursor-pointer' onClick={()=>countCartAdd(smartWatch.id)} >
                           
                              <img className='w-[3.9vw] mb-4 ' src="./assets/add.png" alt="" />
                        </div>
                        <div >
                    ...
                    <div className='flex items-center'>
                      ...
                      <div className='w-4 h-4 border text-[4vw] border-black' >
                          {}
                      </div>
                      <div className='md:pl-4 xxs:pl-1'>
                        <button onClick={()=>handlePay} className='mobileBtn bg-[#20AF48] md:rounded-[36px] xxs:rounded-[16px] md:px-4 xxs:px-2 py-2 text-[#FDFDFD] text-[3vw]'>
                          Pay now
                        </button>
                      </div>
                    </div>
    ...
    <div className='xxs:hidden smd:flex flex-col justify-between relative'>
      <div className=''>
        ...
        <div className='pb-10'>
          ...
          {
            ispay && (
              <div className='bg-[#00000070] z-3000 fixed  top-0 left-0 h-[1000px] w-screen border-[10px] border-green-600'>
