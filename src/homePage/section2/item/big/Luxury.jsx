          ...
          <div className="flex gap-4">
            {luxuryTimePieceData.map((luxuryTime) => (
              ...
              >
                <div className="flex">
                  ...
                  <div className=" w-full flex flex-col justify-center items-center">
                    <div
                      ...
                      onClick={() => handleRemoveFromCart(luxuryTime.id)}
                    >
                      <img
                    ...
                    <div
                      className="cursor-pointer"
                      onClick={() => handleAddToCart(luxuryTime.id)}
                    >
                      <img
                ...
                <div className="cardPrice">N{luxuryTime.price}</div>
                <div className="flex justify-between items-center">
                  ...
                  <div>
                    <div className="border-2 border-[#F24E1E] rounded-[40px] flex items-center px-7 py-2 ">
                      ...
                      <span className="f font-medium">{cartCounts[luxuryTime.id] || 0}</span>
                      </span>
                    </div>
                  </div>
                </div>
