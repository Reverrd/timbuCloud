  ...
  return (
    <div className="section3 sm:h-[100vh] xxs:h-[174px] ">
      <div className='bg-[#0000008a] text-[#FDFDFD] h-full flex flex-col justify-center items-center'>
        ...
        <p className=' xxs:hidden sm:block border text-center xxs:text-[15px] sm:py-5   '>Shop from anywhere in the world. Discover what it means to be the centre of attraction. Shop now and get more</p>
        {/* small screens */}
        ...
        <button className='bg-[#20AF48]'>Order Now</button>
      </div>
    </div>
  )
}
